...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'sodium-tracker-secret-key-change-in-production')
...
if __name__ == '__main__':
    ...
    app.run(debug=debug_mode, port=5003, host='0.0.0.0')